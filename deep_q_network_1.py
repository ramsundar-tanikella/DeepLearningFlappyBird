...
def trainNetwork(s, readout, h_fc1, sess):
    ...
    base_save_dir = "frame_action_data/episodes/round10"
    r = 10
    ...
    while "flappy bird" != "angry bird":
        ...
        if not recording_episode:
            ...
            episode_dir = os.path.join(base_save_dir, f"episode{video_segment+1}_r{r}")
            os.makedirs(episode_dir, exist_ok=True)
            video_filename = os.path.join(episode_dir, f"video_{(video_segment+1):04d}_r{r}.mp4")
